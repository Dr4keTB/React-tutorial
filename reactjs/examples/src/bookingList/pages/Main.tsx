        ...
        <Layout style={{ minHeight: '100vh' }}>
            ...
            <Layout className="site-layout">
                ...
                <Content style={{ margin: '0 16px' }}>
                    ...
                    <Row>
                        <DashBoardCard backgroundColor='#eb7d34' colValue={11} title='Doanh thu ngày' textColor='white' />
                        <DashBoardCard backgroundColor='white' colValue={11} title='Tổng quan' textColor='black'/>
                    </Row>
